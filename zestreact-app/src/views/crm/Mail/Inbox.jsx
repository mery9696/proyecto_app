...
import { mailbox } from 'variables/crm/mailbox.jsx';

import Mailmenu from 'views/crm/Mail/Menu.jsx';

class CrmMailinbox extends React.Component{
    render(){
        return (
            <div>
