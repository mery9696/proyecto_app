...
import { mailbox } from 'variables/blog/mailbox.jsx';

import Mailmenu from 'views/blog/Mail/Menu.jsx';

class BlogMailinbox extends React.Component{
    render(){
        return (
            <div>
