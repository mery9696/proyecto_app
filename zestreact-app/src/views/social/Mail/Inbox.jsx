...
import { mailbox } from 'variables/social/mailbox.jsx';

import Mailmenu from 'views/social/Mail/Menu.jsx';

class SocialMailinbox extends React.Component{
    render(){
        return (
            <div>
...
export default SocialMailinbox;
