...
import { mailbox } from 'variables/hospital/mailbox.jsx';

import Mailmenu from 'views/hospital/Mail/Menu.jsx';

class HospitalMailinbox extends React.Component{
    render(){
        return (
            <div>
...
export default HospitalMailinbox;
