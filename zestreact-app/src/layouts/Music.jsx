...
import dashboardRoutes from 'routes/music.jsx';
import { topbarStyle, menuStyle, menuType, topbarType, navWidth, chatWidth, chatType } from 'variables/settings/music.jsx';

//var ps;

class MusicLayout extends React.Component{
    constructor(props) {
        super(props);
        this.state = { 
            menuColor: menuStyle,
    ...
    render(){
        return (
            <div className="wrapper" ref="themeWrapper" data-menu={this.state.menuColor} data-topbar={this.state.topbarColor} data-menutype={this.state.menuType} data-topbartype={this.state.topbarType}>
                ...
                <Header {...this.props} navtype={navWidth} admintype={'music'}/>
                <Sidebar {...this.props} routes={dashboardRoutes} admintype={'music'}/>
